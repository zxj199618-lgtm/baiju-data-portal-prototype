    ...
    (() => {
      const simpleNav = [
        { group: "分析工作台", icon: "analysis", badge: "5.0", items: [{ name: "分析工作台", badge: "5.0" }, { name: "Skill 配置", badge: "5.0" }] },
      ...
      const permissionGroups = [
        { name: "门户管理员", desc: "管理全站菜单、用户、权限组和所有看板。", menus: ["分析工作台", "Skill 配置", "数据看板", "数据服务", "人群包管理", "API配置", "数据资产", "看板管理", "表管理", "标签管理", "维表管理", "字典管理", "数据推送", "人群包推送渠道", "权限管理", "用户管理", "权限组"], boards: ["全部看板"], tables: ["全部数据表"], status: "启用" },
